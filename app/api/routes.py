...
from .demoService import DemoHellWorld,DemoBigTableGet,DemoServiceReadiness,DemoServiceLiveness,DemoServiceHealth

##
## Actually setup the Api resource routing here
##
def initialize_routes(api): 
    api.add_resource(DemoHellWorld, '/api/v1/demo/1')
